...
int main(int argc, char **argv){
  ...
  goalB.motion_plan_request.allowed_planning_time = ros::Duration(60.0);
...
//  goalB.motion_plan_request.goal_constraints.joint_constraints[6].position = -0.0;
  ...
  goalB.motion_plan_request.goal_constraints.joint_constraints[0].position = -0.01;
  goalB.motion_plan_request.goal_constraints.joint_constraints[1].position = -1.15;
  ...
  goalB.motion_plan_request.goal_constraints.joint_constraints[4].position = -0.01;
  goalB.motion_plan_request.goal_constraints.joint_constraints[5].position = 0.17;
  goalB.motion_plan_request.goal_constraints.joint_constraints[6].position = -0.02;
...
//    ROS_INFO_STREAM("About to send: "<<goalB<<"\n");
    ...
    finished_within_time = move_arm.waitForResult(ros::Duration(180.0));
